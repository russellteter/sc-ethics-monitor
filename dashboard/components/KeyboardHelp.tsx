  ...
  return (
    ...
    >
      <div
        ...
        className="bg-card rounded-lg p-6 max-w-sm w-full shadow-xl border border-line"
      ...
      >
        ...
        <button
          ...
          type="button"
          onClick={onClose}
          className="mt-5 text-xs text-teal-deep underline focus:outline-none focus:ring-2 focus:ring-teal-primary/40 rounded"
        >
          Close
        </button>
      </div>
...
function Row({ label, keyName }: { label: string; keyName: string }) {
  return (
    <div className="flex justify-between items-center">
      ...
      <dd>
        <kbd className="font-mono text-xs px-2 py-0.5 rounded border border-line bg-bg text-ink">
          {keyName}
        </kbd>
      </dd>
    </div>
